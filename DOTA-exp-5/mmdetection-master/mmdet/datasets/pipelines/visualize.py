...
def draw_bounding_box_on_image_poly(image,
  ...
  im_width, im_height = image.size
  if use_normalized_coordinates:
    (pt1_x, pt2_x, pt3_x, pt4_x, pt1_y, pt2_y, pt3_y, pt4_y) = (x0 * im_width, x1 * im_width, x2 * im_width, x3 * im_width,
                                                                y0 * im_height, y1 * im_height, y2 * im_height, y3 * im_height)
  else:
    (pt1_x, pt2_x, pt3_x, pt4_x, pt1_y, pt2_y, pt3_y, pt4_y) = (x0, x1, x2, x3, y0, y1, y2, y3)
