...
if __name__ == '__main__':
    ...
    parser.add_argument("--path", type = str, default = "/home/marina/Workspace/Dataset/DOTA/val/images/", help = "path")
    parser.add_argument("--output", type = str, default = "/home/marina/Workspace/Dataset/DOTA/val/valset.txt", help = "output file")
